...
try:
    ...
    win32api.MessageBox(0, "No invaxion data founded! Have you played invaxion online before April 7th, 2021?\nYou can download a save file by visiting https://share4nothing.ml/Share/\n未找到音灵的游戏数据！ 是否在停服前进行过在线游戏？\n你可以通过访问https://share4nothing.ml/Share/来获取一份存档！", "Warning",win32con.MB_ICONWARNING)
    exit()
winreg.SetValueEx(invaxionReg,winreg.EnumValue(invaxionReg,index)[0],0,winreg.REG_BINARY,b'[{"themeId":1},{"themeId":2},{"themeId":3},{"themeId":4},{"themeId":5},{"themeId":6},{"themeId":7},{"themeId":8},{"themeId":9},{"themeId":10},{"themeId":11},{"themeId":12},{"themeId":13}]\x00')
